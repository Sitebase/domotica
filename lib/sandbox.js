...
{	
	...
	return {
		...
		getWebMenuItems: function() {
			...
			items.push(new MenuItem('Downloader', 'http://192.168.1.109:9091'));
			items.push(new MenuItem('Remote', 'http://192.168.1.109:8080'));
			items.push(new MenuItem('Sick Beard', 'http://192.168.1.109:8081/manage/'));
